...
{
  "llm_mapping": {
    "rules_research": getServiceModel('research_query_generation'),
    "rules_generation": getServiceModel('rules_generation'),
    "rules_examples": getServiceModel('rules_examples')
  }
}
```
